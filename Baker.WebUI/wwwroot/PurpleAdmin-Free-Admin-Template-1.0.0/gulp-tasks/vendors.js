...
gulp.task('clean:vendors', function () {
    return del([
        './~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/**/*'
    ]);
});
...
gulp.task('buildBaseVendorScripts', function () {
    return gulp.src([
        ...
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/js'));
});
...
gulp.task('buildBaseVendorStyles', function () {
    return gulp.src(['../node_modules/perfect-scrollbar/css/perfect-scrollbar.css'])
        ...
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/css'));
});

/*Scripts for addons*/
gulp.task('buildOptionalVendorScripts', function () {
    var aScript1 = gulp.src(['../node_modules/chart.js/dist/chart.umd.js'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/chart.js'));
    var aScript23 = gulp.src(['../node_modules/pwstabs/assets/jquery.pwstabs.min.js'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/pwstabs'));
    var aScript29 = gulp.src(['../node_modules/jquery-file-upload/js/jquery.uploadfile.min.js'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/jquery-file-upload'));
    var aScript33 = gulp.src(['../node_modules/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/bootstrap-datepicker'));
    var aScript38 = gulp.src(['../node_modules/typeahead.js/dist/typeahead.bundle.min.js'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/typeahead.js'));
    var aScript39 = gulp.src(['../node_modules/select2/dist/js/select2.min.js'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/select2'));
    var aScript40 = gulp.src(['../node_modules/codemirror/lib/codemirror.js'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/codemirror'));
    ...
    var aScript59 = gulp.src(['../node_modules/owl-carousel-2/owl.carousel.min.js'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/owl-carousel-2'));
...
gulp.task('buildOptionalVendorStyles', function () {
    var aStyle1 = gulp.src(['../node_modules/@mdi/font/css/materialdesignicons.min.css'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/mdi/css'));
    var aStyle2 = gulp.src(['../node_modules/@mdi/font/fonts/*'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/mdi/fonts'));
    var aStyle3 = gulp.src(['../node_modules/font-awesome/css/font-awesome.min.css'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/font-awesome/css'));
    var aStyle4 = gulp.src(['../node_modules/font-awesome/fonts/*'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/font-awesome/fonts'));
    var aStyle9 = gulp.src(['../node_modules/ti-icons/css/themify-icons.css'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/ti-icons/css'));
    var aStyle10 = gulp.src(['../node_modules/ti-icons/fonts/*'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/ti-icons/fonts'));
    ...
    var aStyle35 = gulp.src(['../node_modules/select2-bootstrap-theme/dist/select2-bootstrap.min.css'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/select2-bootstrap-theme'));
    ...
    var fonts = gulp.src(['./assets/fonts/fonts/*'])
        .pipe(gulp.dest('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/bootstrap-datepicker/fonts'))

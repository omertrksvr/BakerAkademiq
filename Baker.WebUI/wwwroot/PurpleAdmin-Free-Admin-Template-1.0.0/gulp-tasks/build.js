...
function CopyAssetsToTheme() {
    let copyImages = gulp.src('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/images/**/*').pipe(gulp.dest(`../dist/assets/images`))
    let copyJs = gulp.src('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/js/*').pipe(gulp.dest(`../dist/assets/js`))
    let copyVendors = gulp.src('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/vendors/**/*').pipe(gulp.dest(`../dist/assets/vendors`));
    let copyFonts = gulp.src('./assets/fonts/**/*').pipe(gulp.dest(`../dist/assets/fonts`));
    let copyThemeCss = gulp.src('./~/PurpleAdmin-Free-Admin-Template-1.0.0/assets/css/**/*').pipe(gulp.dest('../dist/assets/css'))
